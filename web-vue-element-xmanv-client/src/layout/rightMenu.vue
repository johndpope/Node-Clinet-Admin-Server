            ...
            <ul class="center">
                ...
                <li>
                    ...
                    <div class="sidebar-block__content">
                        <div id="tag-box">
                            <a href="" class="com-icon tag-item">
...
export default {
  ...
  mounted(){
    ...
    (function () {
            const hour_num =that.$refs.hournum;
            const anchor_box = that.$refs.anchorbox;
            let anchor_str = '';
            for (let i = 0; i < 60; i++) {
            ...
            anchor_box.innerHTML=anchor_str;
            ...
            hour_num.innerHTML=hour_str;
            const hour_hand = that.$refs.hourhand;
            const min_hand = that.$refs.minhand;
            const sec_hand =that.$refs.sechand;
            clock_go();
            function clock_go() {
                const date = new Date();
